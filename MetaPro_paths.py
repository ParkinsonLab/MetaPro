...
# object for all paths
    ...
    def __init__ (self, config_path, args_pack):
        ...
        self.rRNA_filter_split_label                = self.value_assignment(self.config, "Labels", "rRNA_filter_split",                  rRNA_filter_split_label_default)   
        self.rRNA_filter_convert_label              = self.value_assignment(self.config, "Labels", "rRNA_filter_convert",                rRNA_filter_convert_label_default)
        self.rRNA_filter_barrnap_label              = self.value_assignment(self.config, "Labels", "rRNA_filter_barrnap",                rRNA_filter_barrnap_label_default)
        self.rRNA_filter_barrnap_merge_label        = self.value_assignment(self.config, "Labels", "rRNA_filter_barrnap_merge",          rRNA_filter_barrnap_merge_label_default)
        self.rRNA_filter_barrnap_pp_label           = self.value_assignment(self.config, "Labels", "rRNA_filter_barrnap_pp",             rRNA_filter_barrnap_pp_label_default)
        self.rRNA_filter_infernal_label             = self.value_assignment(self.config, "Labels", "rRNA_filter_infernal",               rRNA_filter_infernal_label_default)
        self.rRNA_filter_infernal_prep_label        = self.value_assignment(self.config, "Labels", "rRNA_filter_infernal_prep",          rRNA_filter_infernal_prep_label_default)
        self.rRNA_filter_splitter_label             = self.value_assignment(self.config, "Labels", "rRNA_filter_splitter",               rRNA_filter_splitter_label_default)
        self.rRNA_filter_post_label                 = self.value_assignment(self.config, "Labels", "rRNA_filter_post",                   rRNA_filter_post_label_default)
        ...
        self.GA_BWA_pp_label                        = self.value_assignment(self.config, "Labels", "GA_BWA_pp",                          GA_BWA_pp_label_default)
        self.GA_BWA_merge_label                     = self.value_assignment(self.config, "Labels", "GA_BWA_merge",                       GA_BWA_merge_label_default)
        self.GA_BLAT_label                          = self.value_assignment(self.config, "Labels", "GA_BLAT",                            GA_BLAT_label_default)
        self.GA_BLAT_cleanup_label                  = self.value_assignment(self.config, "Labels", "GA_BLAT_cleanup",                    GA_BLAT_cleanup_label_default)
        self.GA_BLAT_cat_label                      = self.value_assignment(self.config, "Labels", "GA_BLAT_cat",                        GA_BLAT_cat_label_default)
        self.GA_BLAT_pp_label                       = self.value_assignment(self.config, "Labels", "GA_BLAT_pp",                         GA_BLAT_pp_label_default)
        self.GA_BLAT_merge_label                    = self.value_assignment(self.config, "Labels", "GA_BLAT_merge",                      GA_BLAT_merge_label_default)
        self.GA_DIAMOND_label                       = self.value_assignment(self.config, "Labels", "GA_DIAMOND",                         GA_DIAMOND_label_default)
        self.GA_DIAMOND_pp_label                    = self.value_assignment(self.config, "Labels", "GA_DIAMOND_pp",                      GA_DIAMOND_pp_label_default)
        ...
        self.ec_detect_label                        = self.value_assignment(self.config, "Labels", "ec_detect",                          ec_annotation_detect_label_default)
        self.ec_priam_label                         = self.value_assignment(self.config, "Labels", "ec_priam",                           ec_annotation_priam_label_default)
        self.ec_priam_split_label                   = self.value_assignment(self.config, "Labels", "ec_priam_split",                     ec_annotation_priam_split_label_default)
        self.ec_priam_cat_label                     = self.value_assignment(self.config, "Labels", "ec_priam_cat",                       ec_annotation_priam_cat_label_default)
        self.ec_DIAMOND_label                       = self.value_assignment(self.config, "Labels", "ec_DIAMOND",                         ec_annotation_DIAMOND_label_default)
        self.ec_pp_label                            = self.value_assignment(self.config, "Labels", "ec_pp",                              ec_annotation_pp_label_default)
        self.output_label                           = self.value_assignment(self.config, "Labels", "outputs",                            output_label_default)
        self.output_copy_gene_map_label             = self.value_assignment(self.config, "Labels", "output_copy_gene_map",               output_copy_gene_map_label_default)
        self.output_clean_ec_label                  = self.value_assignment(self.config, "Labels", "output_clean_ec",                    output_clean_EC_label_default)
        self.output_copy_taxa_label                 = self.value_assignment(self.config, "Labels", "output_copy_taxa",                   output_copy_taxa_label_default)
        self.output_network_generation_label        = self.value_assignment(self.config, "Labels", "output_network_generation",          output_network_gen_label_default)
        self.output_unique_hosts_singletons_label   = self.value_assignment(self.config, "Labels", "output_unique_hosts_singletons",     output_unique_hosts_singletons_label_default)
        self.output_unique_hosts_pair_1_label       = self.value_assignment(self.config, "Labels", "output_unique_hosts_pair_1",         output_unique_hosts_pair_1_label_default)
        self.output_unique_hosts_pair_2_label       = self.value_assignment(self.config, "Labels", "output_unique_hosts_pair_2",         output_unique_hosts_pair_2_label_default)
        self.output_unique_vectors_singletons_label = self.value_assignment(self.config, "Labels", "output_unique_vectors_singletons",   output_unique_vectors_singletons_label_default)
        self.output_unique_vectors_pair_1_label     = self.value_assignment(self.config, "Labels", "output_unique_vectors_pair_1",       output_unique_vectors_pair_1_label_default)
        self.output_unique_vectors_pair_2_label     = self.value_assignment(self.config, "Labels", "output_unique_vectors_pair_2",       output_unique_vectors_pair_2_label_default)
        self.output_combine_hosts_label             = self.value_assignment(self.config, "Labels", "output_combine_hosts",               output_combine_hosts_label_default)
        self.output_per_read_scores_label           = self.value_assignment(self.config, "Labels", "output_per_read_scores",             output_per_read_scores_label_default)
        self.output_contig_stats_label              = self.value_assignment(self.config, "Labels", "output_contig_stats",                output_contig_stats_label_default)
        self.output_ec_heatmap_label                = self.value_assignment(self.config, "Labels", "output_ec_heatmap",                  output_ec_heatmap_label_default)
        self.output_taxa_groupby_label              = self.value_assignment(self.config, "Labels", "output_taxa_groupby",                output_taxa_groupby_label_default)
        self.output_read_count_label                = self.value_assignment(self.config, "Labels", "output_read_count",                  output_read_count_label_default)
