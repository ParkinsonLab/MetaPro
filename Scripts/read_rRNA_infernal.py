...
if __name__ == "__main__":
    ...
    if(data_flag == "paired"):
        ...
        pair_1_mRNA_file = sys.argv[9]  #the read files that get mRNA
        pair_2_mRNA_file = sys.argv[10]  #OUT
    
        pair_1_other_file = sys.argv[11]  #the read files that get other 
        pair_2_other_file = sys.argv[12]  #OUT
    
    else:
        single_inf_file = sys.argv[3]
        single_barrnap_file = sys.argv[4]
        single_raw_file = sys.argv[5]
        single_mRNA_file = sys.argv[6]
        single_other_file = sys.argv[7]
    #-------------------------------------------------------
    ...
    if(data_flag == "paired"):
        ...
        pair_1_mRNA_df = pair_1_raw_df[~pair_1_raw_df["ID"].isin(common_id_list)]
        pair_2_mRNA_df = pair_2_raw_df[~pair_2_raw_df["ID"].isin(common_id_list)]
        
        pair_1_mRNA_size = pair_1_mRNA_df.shape[0]
        pair_1_raw_size = pair_1_raw_df.shape[0]
        print(pair_1_mRNA_size, "vs:", len(common_id_list))
